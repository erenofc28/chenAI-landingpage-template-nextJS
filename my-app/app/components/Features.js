      ...
      <div className="max-w-[1280px] mx-auto flex flex-col items-center gap-12 md:gap-20">
        ...
        <div className="max-w-[768px] w-full flex flex-col items-center gap-4">
          ...
          <div className="flex items-center">
            <p className="text-white text-center font-semibold text-base leading-[150%]">
              Tagline
            </p>
          </div>
          ...
          <div className="flex flex-col items-center gap-6 w-full">
            <h2 className="text-white text-center font-bold text-3xl md:text-5xl leading-[120%]">
        ...
        <div className="flex flex-wrap items-center gap-6">
          <button
            variant="outline"
            className="px-6 py-3 rounded-lg border border-white bg-transparent text-white hover:bg-white/10"
          >
            button
          </button>
          <button className="flex items-center gap-2 text-white text-base font-normal leading-[150%] hover:opacity-80 transition-opacity">
            button
